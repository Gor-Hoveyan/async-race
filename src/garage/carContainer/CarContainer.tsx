...
import { deleteCarThunk, setCars, setQuantity, getAllCarsThunk, setUpdatingCar, handleEngineThunk, setEngineData, setCurrentPageCars, changeOneCarStatus, handleDriveThunk, setUpdateBrand } from '../../redux/reducers/garageReducer';
...
export default function CarContainer({ car }: ComponentProps) {
    ...
    function handleUpdating() {
        if (updatingCar === car.id) {
            ...
            dispatch(setUpdateBrand(car.name));
        }
    }
                ...
                <div className={styles.carData}>
                    <FaCarSide
                        ...
                        style={((
                            ...
                            ?
                            { transform: 'translateX(1000%)', transitionDuration: `${currentEngine[0].distance / currentEngine[0].velocity / 1000}s` }
                            :
                            {}}
                    />
